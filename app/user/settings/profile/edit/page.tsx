...
const page = ({ defaultValues }: ProfileFormProps) => {
  return (
    <div className="w-full mx-auto space-y-8 p-6 bg-white/50 dark:bg-zinc-950/50 backdrop-blur-xs rounded-xl border border-zinc-200/80 dark:border-zinc-800/80 shadow-xs">
      <div className="flex items-center justify-center gap-6">
        ...
        <HoverCard openDelay={0} closeDelay={0}>
          ...
          <HoverCardContent className="text-sm m-1 w-fit">
